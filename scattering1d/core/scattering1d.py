...
def scattering1d(x, backend, psi1, psi2, phi, pad_left=0,
    ...
    U_0_hat = rfft(U_0)
    print('U_0_hat shape: ', U_0_hat.shape)
    ...
    for n1 in range(len(psi1)):
        ...
        print('n1: ', n1)
        print('U_0_hat shape: ', U_0_hat.shape)
        print('psi levels shape: ', psi1[n1]['levels'][0].shape)
        U_1_c = cdgmm(U_0_hat, psi1[n1]['levels'][0])
        print('U_1_c shape: ', U_1_c.shape)

        U_1_c_0 = U_1_c
        U_1_hat = subsample_fourier(U_1_c, 2**k1)
        U_1_c = ifft(U_1_hat)
        print('U_1_c shape: ', U_1_c.shape)
        U_1_c_0 = ifft(U_1_c_0) # YOU WANT TO RETURN THIS
        U_1_c_0 = unpad(U_1_c_0, ind_start[k1], ind_end[k1])
        #print('psi1: ', len(psi1))
        print(U_1_c_0)
        print('yoooooooooooooooooo')
